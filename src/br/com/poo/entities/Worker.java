...
public class Worker {
	...
	//Os próximos métodos serão responsáveis por adicionar e removar um contrato da lista de contratos
	...
	//método para somar o salario base com todos os contratos feitos no mês
